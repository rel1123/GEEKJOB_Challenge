 ...
 * @author stsno
 */
public class errorbr12Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ss2Name = request.getParameter("ssName");
            System.out.println("フォームデータ格納 ss2Name："+ss2Name);
            ss2Age = request.getParameter("ssAge");
            System.out.println("フォームデータ格納 ss2Age："+ss2Age);
            ss2Birthday = request.getParameter("ssBirthday");
            System.out.println("フォームデータ格納 ss2Birthday："+ss2Birthday); 
...
//            System.out.print("フォームデータName："+sName);
    ...
    //            nBirthday = request.getParameter("nBirthday");
            ...
            if(ss2Name != null){
                if(!(ss2Name.equals(""))){
                ssName = ss2Name;
                System.out.println("フォームデータssName："+ssName);
                }
                if(!(ss2Age.equals(""))){
                ssAge = Integer.valueOf(ss2Age);
                System.out.println("フォームデータssAge："+ssAge);
                }
                if(!(ss2Birthday.equals(""))){
                ssBirthday = ss2Birthday;
                System.out.println("フォームデータssBirthday："+ssBirthday);
                }
            }
...
//                db_con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Challenge_db","root","");
        ...
        //                db_con.commit();
                ...
                //フォームデータから検索
                if(ss2Name != null){
                    if(!(ss2Name.equals("")) && !(ss2Age.equals("")) && !(ss2Birthday.equals(""))){
                        db_st = db_con.prepareStatement("select * from profiles where name = '" + ssName + "' and age = " + ssAge + " and birthday = '"+ssBirthday+"'");
