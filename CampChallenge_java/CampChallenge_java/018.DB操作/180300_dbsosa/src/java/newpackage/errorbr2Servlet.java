 ...
 * @author stsno
 */
@WebServlet(name = "errorbr2Servlet", urlPatterns = {"/errorbr2Servlet"})
public class errorbr2Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet errorbr2Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
