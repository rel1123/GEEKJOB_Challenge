 ...
 * @author stsno
 */
public class DbSarvlet extends HttpServlet {
    ...
    if(login){
        ...
        switch (submitType){
            case "一覧表示します！"://検索
                ...
                break;
            case "商品登録します！":
                int iPrID = Integer.valueOf(request.getParameter("iPrID"));
                System.out.print("iProID："+iPrID);
                String iPrName = request.getParameter("iPrName");
                int iSePrice = Integer.valueOf(request.getParameter("iSePrice"));
                int iPuPrice = Integer.valueOf(request.getParameter("iPuPrice"));
                String iPrType = request.getParameter("iPrType");
                String iPuType = request.getParameter("iPuType");
                dbClass.Insert(iPrID, iPrName, iSePrice, iPuPrice, iPrType, iPuType);
                break;
            default:
                break;
        }
...
//            Failure
            ...
            data.setProductData(dbClass.productData);
