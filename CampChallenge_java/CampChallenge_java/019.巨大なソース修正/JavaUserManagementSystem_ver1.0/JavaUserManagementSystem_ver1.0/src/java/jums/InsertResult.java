...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            birthday.set(Calendar.YEAR, Integer.valueOf((String)session.getAttribute("year")));
            birthday.set(Calendar.MONTH, Integer.valueOf((String)session.getAttribute("month")) - 1);
            birthday.set(Calendar.DATE, Integer.valueOf((String)session.getAttribute("day")));
