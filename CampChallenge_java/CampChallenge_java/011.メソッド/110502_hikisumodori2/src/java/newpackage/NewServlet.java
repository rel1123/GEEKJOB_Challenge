    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for(int i = 1; i <= 2; i++){
                //profile（i番目）を表示
                //誕生日と住所を表示
                if(profile("000002").get(i) == null){
                    continue;
                }
                out.print(profile("000002").get(i)+"<br>");
            }
            
            for(int i = 1; i <= 2; i++){
                //profile（i番目）を表示
                //誕生日と住所を表示
                if(profile("000003").get(i) == null){
                    continue;
                }
                out.print(profile("000003").get(i)+"<br>");
            }
