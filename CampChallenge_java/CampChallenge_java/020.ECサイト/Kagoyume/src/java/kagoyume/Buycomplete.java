                ...
                if((boolean)session.getAttribute("login")){
                    ...
                    if(session.getAttribute("cartData"+String.valueOf(udd.getUserID())) !=null){
                        ...
                        for(int i = 0; i < cartData.size(); i++){
                            ...
                            //データベースへ商品情報を挿入
                            try{
                            UserDataDAO.getInstance().buyInsert(udd.getUserID(), code, itemData.getShippingCode());
                            }catch(Exception e){
                        ...
                        //データベースの合計購入金額を更新
                        try{
                        UserDataDAO.getInstance().totalUpdate(udd.getUserID(), total);
                        //ログイン情報アップデート
                        ...
                        //セッション削除
                        session.removeAttribute("cartData"+String.valueOf(udd.getUserID()));
